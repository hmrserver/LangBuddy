...
export const Card = ({ title, description, image, clipurl }) => {
  ...
  if (selectedCard) {
    return (
      <div className="p-4 m-4 basis-1/4">
  ...
  return (
    <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 m-4 basis-1/4">
      <a>
